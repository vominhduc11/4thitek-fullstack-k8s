...
case $choice in
    ...
    4)
        ...
        echo "  Redis Commander: http://localhost:30082"
        echo "    🔐 Username: admin"
...
echo ""
echo "🔧 Redis Connection Details (for web interfaces):"
echo "  Host: redis-service"
echo "  Port: 6379"
echo "  🔐 Auth Password: Redis-Secure-2024!"
echo "  (Configure authentication in the web interface)"
echo ""
echo "ℹ️  Note: Redis now requires authentication - use password when connecting"
echo ""
